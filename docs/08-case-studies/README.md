...
| # | プロジェクト | スケール | 複雑度 | 重点 |
|---|-----------|--------|------|------|
| [01](./01-ecommerce-site.md) | **ECサイト** | 中規模 | ★★★★☆ | 複数の決済方法、在庫管理、注文フロー |
| [02](./02-sns-platform.md) | **SNS** | 大規模 | ★★★★★ | フィード生成、キャッシング、スケーリング |
| [03](./03-microservices.md) | **マイクロサービス** | 大規模 | ★★★★★ | サービス分割、非同期通信、サガパターン |
