...
## 7.4 04: 循環依存（Circular Dependency）
...
## 8.2 02: SNS プラットフォーム（フィード生成・キャッシング）
...
##### 9.4.4.1.3 ③ typescript-clean-architecture
